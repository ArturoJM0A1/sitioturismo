...
<div class="Menu">
                    ...
                    <div class="TarjetaNoticia <?= implode(' ', $categoriasArray) ?>">
                        <div class="cuerpoNoticia">
                            ...
                            <div class="contenidoNoticia">
                                ...
                                <div class="boton">
                                    <a class="cardboton"
                                        href="CompletaNoticia.php?id=<?= $Noticia['id'] ?>">Leer
                                        más</a>
                                </div>
    ...
    <script src="NoticiasPublicadas/js/buscarNoticia.js"></script>
    <script src="NoticiasPublicadas/js/Crearboton.js"></script>
    <script src="NoticiasPublicadas/js/IrA.js"></script>

    <script src="NoticiasPublicadas/js/quitarfiltro.js"></script>
